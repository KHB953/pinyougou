 //控制层 
app.controller('contentController' ,function($scope,$controller   ,contentService,manager_uploadService,contentCategoryService){
	...
	$scope.uploadFile=function () {
		manager_uploadService.uploadFile().success(
            function (response) {
                if (response.success) {
                    //上传成功
